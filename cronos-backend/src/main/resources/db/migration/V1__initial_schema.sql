...
CREATE INDEX idx_service_categories_tenant_order ON service_categories(tenant_id, display_order);
...
CREATE UNIQUE INDEX idx_staff_tenant_user ON staff(tenant_id, user_id);
...
-- Add foreign keys from appointments to staff and clients
